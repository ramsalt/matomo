...
trusted_hosts[] = "${MATOMO_TRUSTED_HOST_0}"
trusted_hosts[] = "${MATOMO_TRUSTED_HOST_1}"
trusted_hosts[] = "${MATOMO_TRUSTED_HOST_2}"
trusted_hosts[] = "${MATOMO_TRUSTED_HOST_3}"
salt = "4325a52bf1bc4bad5ed57c76d13aed56"
proxy_client_headers[] = "${MATOMO_PROXY_CLIENT_HEADER_0}"
proxy_client_headers[] = "${MATOMO_PROXY_CLIENT_HEADER_1}"
proxy_client_headers[] = "${MATOMO_PROXY_CLIENT_HEADER_2}"
proxy_client_headers[] = "${MATOMO_PROXY_CLIENT_HEADER_3}"
proxy_ip_read_last_in_list = ${MATOMO_PROXY_IP_READ_LAST_IN_LIST:-1}
